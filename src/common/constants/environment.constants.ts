export class EnvironmentConstants {
  ...
  static CONFIRM_EMAIL_TOKEN_SECRET = 'CONFIRM_EMAIL_TOKEN_SECRET';
  static CONFIRM_EMAIL_TOKEN_EXPIRES_IN = 'CONFIRM_EMAIL_TOKEN_EXPIRES_IN';
  static HASH_IDS_SECRET = 'HASH_IDS_SECRET';
}
